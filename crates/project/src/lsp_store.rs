...
use language::{
    ...
    ManifestDelegate, ManifestName, OffsetUtf16, Patch, PointUtf16, TextBufferSnapshot, ToOffset,
        ...
        for formatter in formatters {
            ...
            match formatter {
                ...
                Formatter::Prettier => {
                    ...
                    // When selection ranges are provided (via FormatSelections), pass the
                    // encompassing UTF-16 range to Prettier and retain only diff edits that
                    // overlap the original selected byte ranges.
