    ...
    pub fn add_center_terminal(
        ...
        cx.spawn_in(window, async move |workspace, cx| {
            ...
            workspace.update_in(cx, |workspace, window, cx| {
                ...
                if !workspace.add_item_to_center_with_focus(terminal_view, focus_item, window, cx) {
                    let terminal_view = Box::new(cx.new(|cx| {
                        TerminalView::new(
                            terminal.clone(),
                            weak_workspace,
                    ...
                    workspace.add_item_to_active_pane(terminal_view, None, focus_item, window, cx);
                }
            })?;
            ...
            .update_in(cx, |workspace, window, cx| {
                TerminalPanel::add_center_terminal(workspace, window, cx, |_, cx| {
                    let terminal = cx.new(|cx| {
                        ...
                        .expect("display-only terminal should be created")
                        .subscribe(cx)
                    });
